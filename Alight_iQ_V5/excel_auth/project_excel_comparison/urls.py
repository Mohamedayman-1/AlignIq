...
from .views.comparison_views import (
    ...
    AnalyzeExcelTableView, UpdateComparisonView,
    ComparisonRowDetailView, UpdateComparisonRowView, ExportComparisonView
)
...
urlpatterns = [
    ...
    path('update-comparison/<int:comparison_id>/', UpdateComparisonView.as_view(), name='update-comparison'),
    path('comparison-row/<int:row_id>/', ComparisonRowDetailView.as_view(), name='comparison-row-detail'),
    path('update-comparison-row/<int:row_id>/', UpdateComparisonRowView.as_view(), name='update-comparison-row'),
    path('export-comparison/<int:comparison_id>/', ExportComparisonView.as_view(), name='export-comparison'),
